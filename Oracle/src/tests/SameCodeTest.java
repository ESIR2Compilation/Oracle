...
public class SameCodeTest extends AbstractTest{
	...
	public void tester() {
		...
		//Maintenant que les deux fichiers sont chargés, il nous reste plus qu'à les comparer.
		...
		// On a donc uniquement les termes nécessaires : plus aucune mise en forme existe.
		
		if (contentEntry.equals(contentOutput)){
			rapport = OK + getClass().getSimpleName() + " : Le pretty printing réutilise exactement le même nombre de terme employé dans le fichier d'entrée.";
			estValide = true;
		}
		else {
